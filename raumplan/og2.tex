...
\begin{tikzpicture}
\node at (9.5,10) {\Huge \textbf{2. Obergeschoss}};
%\draw (0,0) -- (20,0) -- (20,20) -- (0,20) -- (0,0); % Canvas
% \draw (,) -- (,);
\fill[yellow!20] (1,1) -- (1,11) -- (3,11) -- (3,4.5) -- (4,4.5) -- (4,7) -- (14,7) -- (14,5) -- (16,5) -- (16,1) -- (3,1) -- (1,1);
\fill[gray!30] (16,1) rectangle (18,11);
\fill[gray!30] (1,1) rectangle (3,11);
...
\draw (12,5) -- (13.5,5);
\draw (14,5) -- (16,5);
\draw[dashed] (1,9) -- (1,11);
\draw[dashed] (3,9) -- (3,11);
\draw[dashed] (16,9) -- (16,11);
\draw[dashed] (18,9) -- (18,11);
...
\node at (5.5,2) {\Large \textbf{SR 2.404}};
\node at (8.5,2) {\Large \textbf{SR 2.403}};
\node at (11.5,2) {\Large \textbf{SR 2.402}};
