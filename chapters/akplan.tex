...
%Labels
\node[above] at (0.25*\textwidth,0.95*\height) {SLOT I:   Donnerstag 8:00\,--\,10:00};
\node[above] at (0.75*\textwidth,0.95*\height) {SLOT II:  Donnerstag 10:30\,--\,12:30};
\node[above] at (0.25*\textwidth,0.7*\height) {SLOT III: Donnerstag 14:00\,--\,16:00};
\node[above] at (0.75*\textwidth,0.7*\height) {SLOT IV: Donnerstag 16:30\,--\,18:30};
\node[above] at (0.25*\textwidth,0.45*\height) {SLOT V: Samstag 9:00\,--\,11:00};
\node[above] at (0.75*\textwidth,0.45*\height) {SLOT VI: Samstag 11:30\,--\,13:30};
\node[above] at (0.25*\textwidth,0.2*\height) {SLOT VII: Samstag 15:00\,--\,17:00};
